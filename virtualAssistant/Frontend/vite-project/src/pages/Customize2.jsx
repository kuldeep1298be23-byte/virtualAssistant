...
function Customize2(){
    ...
    return(
        ...
        disabled={loading} onClick={()=>{ handleUpdateAssistant() }}>{!loading?"Finally Create Your Assistant":"Loading.."}</button>}
        </div>
    )
}
export default Customize2;
//* jaise hi hum button par click karenge then, we update our assistant for this we can create our controller.
//*then hum apni assistant ki details fill karwa denge.